...
two_coords = [[], [], []]
three_coords = [[], [], [], []]
menu_img = pygame.image.load("C:/Users/OMEN/OneDrive/ドキュメント/shoot_game/assets/menus/mainMenu.png")
game_over_img = pygame.image.load("C:/Users/OMEN/OneDrive/ドキュメント/shoot_game/assets/menus/gameOver.png")
pause_img = pygame.image.load("C:/Users/OMEN/OneDrive/ドキュメント/shoot_game/assets/menus/pause.png")
for i in range(1, 4):
    # Background and Banner loading with dynamic paths
    bgs.append(pygame.image.load(f"C:/Users/OMEN/OneDrive/ドキュメント/shoot_game/assets/bgs/{i}.png"))
    banners.append(pygame.image.load(f"C:/Users/OMEN/OneDrive/ドキュメント/shoot_game/assets/banners/{i}.png"))
    
    # Gun loading with dynamic paths
    guns.append(pygame.transform.scale(pygame.image.load(f"C:/Users/OMEN/OneDrive/ドキュメント/shoot_game/assets/guns/{i}.png"), (100, 100)))
    
    # Target images with dynamic paths for each i and j
    if i < 3:
        for j in range(1, 4):
            target_images[i - 1].append(pygame.transform.scale(
                pygame.image.load(f"C:/Users/OMEN/OneDrive/ドキュメント/shoot_game/assets/targets/{i}/{j}.png"),
                (120 - (j * 18), 80 - (j * 12))))
    else:
        for j in range(1, 5):
            target_images[i - 1].append(pygame.transform.scale(
...
file = open("C:/Users/OMEN/OneDrive/ドキュメント/shoot_game/high_scores.txt", 'r')
...
pygame.mixer.init()
pygame.mixer.music.load("C:/Users/OMEN/OneDrive/ドキュメント/shoot_game/assets/sounds/bg_music.mp3")
plate_sound = pygame.mixer.Sound("C:/Users/OMEN/OneDrive/ドキュメント/shoot_game/assets/sounds/Broken plates.wav")
plate_sound.set_volume(.2)
bird_sound = pygame.mixer.Sound("C:/Users/OMEN/OneDrive/ドキュメント/shoot_game/assets/sounds/Drill Gear.mp3")
bird_sound.set_volume(.2)
laser_sound = pygame.mixer.Sound("C:/Users/OMEN/OneDrive/ドキュメント/shoot_game/assets/sounds/Laser Gun.wav")
